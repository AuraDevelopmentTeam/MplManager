...
public class DependencyJar {
  ...
  public DependencyJar(
      String groupId, String artifactId, String version, DependencyJar... dependencies) {
  ...
  public DependencyJar(
      String groupId, String artifactId, String version, Dependency... dependencies) {
    this(groupId, artifactId, version);
